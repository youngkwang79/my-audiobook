# -*- coding: utf-8 -*-
"""
상단 검색바의 배경색을 하단 내비게이션 바와 마찬가지로 신뢰감 주는 어두운 네이비 블루 컬러(#0b0f19)로 반전 매칭하여 
고급스럽고 일체화된 다크 상하단 포인트 스타일을 완성한 V5.9 CSS 갱신 스크립트
"""
import os
...
def update_css_v5_9():
    ...
    css_content = """/* ========================================================
   [V5.9 내추럴 웜 아이보리 화이트 테마 - 상하단 다크 매칭 포인트 디자인] 
   ======================================================== */
...
"""
    with open(file_path, "w", encoding="utf-8") as f:
        f.write(css_content)
    print("[SUCCESS] CSS compiled V5.9. Changed search bar to dark mode matches bottom nav.")
