# -*- coding: utf-8 -*-
"""
하단 메인 탭 바에 '법률/소송'을 전면 고정 배치하도록 wordpress_bottom_nav.html을 개편하는 스크립트
"""

import os

def update_bottom_nav_with_law_tab():
...
<div class="wp-bottom-nav-wrapper">
  <!-- 하단 탭 내비게이션 (법률/소송 탭 바에 전면 고정 노출 설계) -->
  <div class="wp-bottom-nav">
    ...
    <!-- 3. 법률/소송 (신규 메인 탭 고정) -->
    <a href="https://blog.murimbook.com/category/law/" class="wp-nav-item wp-nav-law">
      <svg class="wp-nav-icon accent-law" viewBox="0 0 24 24" style="fill: #38bdf8 !important;">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
      </svg>
      <span style="color: #38bdf8 !important; font-weight: bold;">법률/소송</span>
    </a>
    
    <!-- 4. 대출 계산기 -->
    <a href="https://blog.murimbook.com/%eb%8c%80%ec%b6%9c-%ec%9d%b4%ec%9e%90-%ea%b3%84%ec%82%b0%ea%b8%b0-100-%eb%ac%b4%eb%a3%8c/" class="wp-nav-item wp-nav-calc">
...
"""
    ...
    print("[SUCCESS] Bottom nav HTML file rebuilt with dedicated 'Law' category tab!")

if __name__ == "__main__":
    update_bottom_nav_with_law_tab()
