# -*- coding: utf-8 -*-
"""
모바일 전용 상단 검색바(.mobile-app-search-bar)가 숨겨지지 않고 
정상적으로 활성화되어 노출되도록 CSS 선택자 규칙을 고도화하여 수정한 V5.5 CSS 갱신 스크립트
"""
import os
...
def update_css_v5_5():
    ...
    css_content = """/* ========================================================
   [V5.5 무결점 내추럴 웜 아이보리 화이트 테마 - 모바일 전용 검색창 부활판] 
   ======================================================== */
...
"""
    with open(file_path, "w", encoding="utf-8") as f:
        f.write(css_content)
    print("[SUCCESS] CSS compiled V5.5. Re-enabled mobile custom search bar.")
