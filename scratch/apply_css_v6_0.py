# -*- coding: utf-8 -*-
"""
상단 고정 검색바 밑에 배치되는 본문 콘텐츠(대표 썸네일 이미지 등)가 검색 영역에 의해 
가려지거나 잘리는 현상을 완벽하게 방지하기 위해 모바일 상단 마진 여백을 105px로 추가 확장하고 
아이프레임 및 개별 문서의 첫 번째 콘텐츠 요소를 밀어내도록 최적화한 V6.0 CSS 갱신 스크립트
"""
import os
...
def update_css_v6_0():
    ...
    css_content = """/* ========================================================
   [V6.0 내추럴 웜 아이보리 화이트 테마 - 모바일 썸네일 잘림 완전 방지판] 
   ======================================================== */
...
@media (max-width: 768px) {
    ...
    #page {
        margin-top: 105px !important; /* 기존 80px에서 105px로 여백 대폭 확장하여 썸네일 잘림 완전 박멸 */
    }
...
"""
    with open(file_path, "w", encoding="utf-8") as f:
        f.write(css_content)
    print("[SUCCESS] CSS compiled to V6.0. Set page margin-top to 105px to prevent thumbnail clipping.")
