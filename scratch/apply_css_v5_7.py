# -*- coding: utf-8 -*-
"""
1. 모바일 카테고리(아카이브) 페이지 및 모든 글 상세 페이지에서 모바일 상단 고정 검색바와 본문 썸네일/헤더 영역이 겹쳐서 잘리지 않도록 
   상단 마진 여백을 강제 보정(55px -> 80px)하고 아카이브 헤더 마진을 일괄 튜닝한 V5.7 CSS 갱신 스크립트
"""
import os
...
def update_css_v5_7():
    ...
    css_content = """/* ========================================================
   [V5.7 내추럴 웜 아이보리 화이트 테마 - 모바일 겹침/가림 방지 및 마진 튜닝판] 
   ======================================================== */
...
"""
    with open(file_path, "w", encoding="utf-8") as f:
        f.write(css_content)
    print("[SUCCESS] CSS compiled to V5.7. Fixed body padding for top sticky search bar.")
