# -*- coding: utf-8 -*-
"""
모바일 뷰에서 본문 이미지들이 가로 폭을 넘지 않고 자동으로 100% 반응형 최적화되도록 4.3버전 CSS 업데이트 스크립트
"""

import os

def optimize_images_responsively():
    file_path = "d:/소설 유투브/my-audiobook/my_audiobook/naver_post_assets/senior_care_custom.css"
    
    css_content = """/* ========================================================
   [V4.3 무결점 울트라 다크 실버 테마] 
   모바일 본문 이미지 100% 반응형 최적화 및 가로 스크롤 박멸 완결판
   ======================================================== */
...
/* 3. 본문 내 모든 이미지(태그 및 WP 블록 이미지) 모바일 100% 강제 반응형 최적화 */
img, 
.wp-block-image img, 
.entry-content img,
.inside-article img,
...
/* 9. 본문 중앙 콘텐츠 박스 세련된 차콜 입체 액자 튜닝 */
.inside-article,
...
"""
    with open(file_path, "w", encoding="utf-8") as f:
        f.write(css_content)
    print("[SUCCESS] V4.3 CSS file created and image responsive attributes updated!")

if __name__ == "__main__":
    optimize_images_responsively()
