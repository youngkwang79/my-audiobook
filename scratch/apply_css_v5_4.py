# -*- coding: utf-8 -*-
"""
본문 중앙 콘텐츠 카드 테두리 선의 굵기(1px -> 2px)와 색상(#e6e4e0 -> #ccc8c2)을 진하게 보강하고, 
하단 댓글 영역 경계도 더 명확하게 선을 더 진하게 보정한 V5.4 CSS 갱신 스크립트
"""
import os
...
def update_css_v5_4():
    ...
    css_content = """/* ========================================================
   [V5.4 무결점 내추럴 웜 아이보리 화이트 테마 - 콘텐츠 경계선 보강판] 
   ======================================================== */
...
/* 5. 우측에 튀어나와서 화면을 밀어버리던 테마 기본 검색창, 돋보기, 버튼 강제 파괴 */
.menu-bar-items,
.menu-bar-item,
.gp-icon.icon-search,
.search-item,
...
/* 9. 본문 중앙 콘텐츠 박스 테두리선 굵기(2px) 및 색상(#ccc8c2) 진하게 강화 */
.inside-article,
...
"""
    with open(file_path, "w", encoding="utf-8") as f:
        f.write(css_content)
    print("[SUCCESS] CSS compiled with V5.4 stronger border line settings.")
