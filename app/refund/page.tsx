      ...
      <div className="terms-container">
        ...
        <div className="terms-content">
          <div className="terms-alert-box">
            💳 무림북은 창작자 후원과 디지털 콘텐츠 이용에 투명하고 공정한 결제 정책을 운영합니다. 전자상거래법 및 관계 법령을 준수하면서 플랫폼 남용을 막기 위한 정책을 적용하고 있으니 결제 전 내용을 반드시 숙지해 주시기 바랍니다.
          </div>

          <section className="terms-section">
            <h2 className="terms-section-title">제1조 (결제 및 코인 충전)</h2>
            <ul className="terms-bullet-list">
              <li>이용자는 신용카드, 계좌이체, 간편결제 등 회사가 제공하는 결제 수단을 통해 자발적 창작자 후원 목적의 대금을 결제하고 리워드로 '코인(포인트)'을 지급받거나 '정액 멤버십 후원'을 개시할 수 있습니다.</li>
          ...
          <section className="terms-section">
            ...
            <ul className="terms-bullet-list">
              ...
              <li><strong>정액 멤버십 후원</strong>: 멤버십 가입 즉시 후원 전용 음원 청취 혜택 및 무제한 스트리밍 서비스 권한이 활성화되므로 결제 완료 이후에는 취소 및 중도 환불이 불가능합니다.</li>
