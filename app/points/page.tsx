    ...
    () => [
      {
        ...
        price: 1000,
        points: 1000,
        priceLabel: formatWon(1000),
        pointsLabel: formatP(1000),
      },
      {
        id: "p2",
        price: 3000,
        points: 3300,
        bonus: "보너스 +10%",
        priceLabel: formatWon(3000),
        pointsLabel: formatP(3300),
      },
      {
        id: "p3",
        price: 5000,
        points: 5800,
        bonus: "보너스 +16%",
        priceLabel: formatWon(5000),
        pointsLabel: formatP(5800),
      },
      {
        id: "p4",
        price: 10000,
        points: 12000,
        bonus: "보너스 +20%",
        priceLabel: formatWon(10000),
        pointsLabel: formatP(12000),
      },
    ],
    []
  );
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        <h1 style={{ margin: "8px 0 12px", fontSize: 28, fontWeight: 950 }}>
          포인트 충전
        </h1>
...
>
  홈으로
        ...
        >
          ...
          <button
            onClick={() =>
              alert("STEP 2에서 결제사(토스/카카오페이) 연결을 붙일 거예요!")
            }
            style={{
              width: "100%",
              background:
