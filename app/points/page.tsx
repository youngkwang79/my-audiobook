                  ...
                  {showDetailSection === "purchase" && (
                    <>
                      ...
                      <ul>
                        ...
                        <li><strong>결제 금액:</strong> {pendingPurchase?.type === "coin" ? `₩${pendingPurchase.amount.toLocaleString()}` : ""}</li>
                        <li><strong>청약 철회 안내:</strong> 본 상품은 디지털 콘텐츠 상품 및 충전 서비스이므로 결제 완료 후 중도 철회나 단순 변심으로 인한 환불이 불가능합니다.</li>
