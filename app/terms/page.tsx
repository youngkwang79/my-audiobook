      ...
      <div className="terms-container">
        ...
        <div className="terms-content">
          <div className="terms-alert-box">
            📢 무림북은 창작자(작가)를 위한 자발적 후원 모델을 기반으로 하며, 결제 시 리워드 코인 지급과 동시에 서비스 감상 권한이 즉시 개시되는 디지털 콘텐츠 사이트입니다. 결제 전 약관을 신중하게 확인해 주시기 바랍니다.
          </div>
          ...
          <section className="terms-section">
            ...
            <ul className="terms-bullet-list">
              ...
              <li><strong>후원 결제</strong>: 콘텐츠 창작자(작가)에 대한 창작 지원 및 플랫폼 후원을 목적으로 자발적으로 대금을 결제하는 행위를 의미합니다.</li>
            </ul>
          </section>
 
          <section className="terms-section">
            <h2 className="terms-section-title">제3조 (자발적 후원 결제 및 서비스 성격)</h2>
            <ul className="terms-bullet-list">
              <li>이용자가 서비스 내에서 수행하는 결제(코인 충전 및 정액 멤버십 후원)는 기본적으로 콘텐츠 원작자(작가)의 지속적인 창작 활동을 지지하고 응원하는 자발적인 <strong>'창작자 후원금 및 기부 지원금'</strong>의 성격을 지닙니다.</li>
              <li>회사는 후원 결제에 동참해 주신 이용자분들에 대한 감사 및 리워드 제공의 일환으로, 유료 콘텐츠 감상에 사용할 수 있는 <strong>'리워드 코인(포인트)'</strong> 및 <strong>'정액 멤버십 이용 권한'</strong>을 즉시 부여합니다.</li>
          ...
          <section className="terms-section">
            ...
            <ul className="terms-bullet-list">
              <li>서비스 내 제공되는 모든 오디오 음원, 이미지, 썸네일, 텍스트, 사용자 인터페이스 등 일체의 콘텐츠 저작권 및 지적재산권은 회사 및 원저작권자(작가)에게 독점적으로 귀속됩니다.</li>
