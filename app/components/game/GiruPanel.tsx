        ...
        {!selectedNpc ? (
          ...
          <div style={{ height: "100%", display: "flex", flexDirection: "column", padding: "16px" }}>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", overflowY: "auto" }} className="hide-scrollbar">
              <div style={{ display: "flex", justifyContent: "center", marginBottom: "10px", height: "240px" }}>
                {(() => {
                  const style = npcStyles[selectedNpc.id] || { scale: 1, y: 0, height: "100%" };
                  const dialogScale = style.scale * 0.8;
                  const dialogY = style.y * 0.5;
                  return (
                    <motion.img 
                      initial={{ opacity: 0, scale: dialogScale * 0.8, y: dialogY }}
                      animate={{ opacity: 1, scale: dialogScale, y: dialogY }}
                      src={npcImages[selectedNpc.id] || "/images/dummy.png"} 
