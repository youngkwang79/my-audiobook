...
WIKI_RESOURCES = [
    ...
    ("부동산", "https://ko.wikipedia.org/wiki/%EB%B%80%EB%8F%99%EC%82%B0"),
...
{docs_list_html}  </ul>
  ...
  - <a href="{url}" target="_blank" rel="noopener noreferrer" style="color: #1565c0; text-decoration: underline; font-weight: bold;">{desc} 바로가기</a>
    ...
    # 📌 본문용 마크다운 구성: alt_text_guide 안내 박스를 원천 삭제함!
...
def main():
    print(f"=== [원고 라이터 v24-CleanBodyAlt] 9대 채널 27개 본문 Alt 제외 컴파일 개시 ===")
...
"""
    ...
    print(f"\n🎉 [대성공] 각 날짜 폴더마다 본문에서 Alt 설명이 완벽 제외된 'thumbnail_prompts.html' 파일 생성이 완벽 완료되었습니다!")
